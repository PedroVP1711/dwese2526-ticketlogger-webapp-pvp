...
import org.iesalixar.daw2.pvp.dwese2526_ticketlogger_api_pvp.dtos.UserCreateDTO;
import org.iesalixar.daw2.pvp.dwese2526_ticketlogger_api_pvp.dtos.UserDTO;
import org.iesalixar.daw2.pvp.dwese2526_ticketlogger_api_pvp.dtos.UserDetailDTO;
import org.iesalixar.daw2.pvp.dwese2526_ticketlogger_api_pvp.dtos.UserUpdateDTO;
import org.iesalixar.daw2.pvp.dwese2526_ticketlogger_api_pvp.entities.User;
import org.iesalixar.daw2.pvp.dwese2526_ticketlogger_api_pvp.mappers.UserMapper;
import org.iesalixar.daw2.pvp.dwese2526_ticketlogger_api_pvp.repositories.roleRepository;
...
public class UserController {
    ...
    public String listUsers(Model model, @PageableDefault(size = 10, sort = "id") Pageable pageable) {
        try {
            ...
            Page<UserDTO> usersDTOPage = usersPage.map(UserMapper::toDTO); // mapper seguro

            model.addAttribute("page", usersDTOPage);

            String sortParam = "id,asc";
            if (usersPage.getSort().isSorted()) {
                var order = usersPage.getSort().iterator().next();
            ...
            model.addAttribute("errorMessage", "No se pudo cargar la lista de usuarios");
            model.addAttribute("page", Page.empty());
            model.addAttribute("sortParam", "id,asc");
        }
    ...
    public String showEditForm(@RequestParam("id") Long id, Model model) {
        ...
        if (userOpt.isEmpty()) return "redirect:/user";
